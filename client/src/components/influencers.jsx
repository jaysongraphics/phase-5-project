...
function Influencers() {
    ...
    return (
        <div className="influencers-section">
             <p className="influencers-title">Celebrities</p>
            <div id="influencers-div" className="ui move reveal">
           
                <div id="visible-img" className="visible content">
                    <img id="influencers-img" alt="inf1" 
                    src={female}className="ui small image" 
                    style={{width: 250, height: 200}}/>
                </div>

                <div className="hidden content">
                    <img id="influencers-img" alt="inf2"
            ...
            <div id="influencers-div" className="ui move reveal">
                <div id="visible-img" className="visible content">
                    <img id="influencers-img" alt="inf3"
                    src={male2}className="ui small image" 
                    style={{width: 250, height: 200}}/>
                </div>

                <div className="hidden content">
                    <img id="influencers-img" alt="inf4"
                    src={rock} className="ui small image" 
                    style={{width: 200, height: 200}}/>
                    <br />
        ...
        <div id="influencers-div" className="ui move reveal">
            <div id="visible-img" className="visible content">
                <img id="influencers-img" alt="inf5"
                src={female}className="ui small image" 
                style={{width: 250, height: 200}}/>
            </div>
            
            <div className="hidden content">
                <img id="influencers-img" alt="inf6"
        ...
        <div id="influencers-div" className="ui move reveal">
            ...
            <div className="hidden content">
                <img id="influencers-img" alt="inf8"
                src={prince} className="ui small image" 
                style={{width: 200, height: 200}}/>
                <br />
