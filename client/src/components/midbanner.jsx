           ...
           <div className="mid-section">
            ...
            <div className="mid-services-div">
                <div className="mid-book">
                    <img id="midbanner-image" alt="homeimg2" 
                    className="ui medium circular image" src={image2}/>
                ...
                <div className="mid-review">
                    <img id="midbanner-image" alt="homeimg3"
                    className="ui medium circular image" src={image3}/>
                ...
                <div className="mid-share">
                    <img id="midbanner-image"  alt="homeimg4" 
                    className="ui medium circular image" src={image4}/>
                ...
                <div className="mid-chat">
                    <img id="midbanner-image" alt="homeimg5"
                    className="ui medium circular image" src={image5}/>
