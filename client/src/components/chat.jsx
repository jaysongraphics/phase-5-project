...
const groupChat = newChatName.map(chatGroupName => <div>
       {/* {chatModal ? <ChatModal 
...
<p onClick={handleGroupChat} style={{cursor: 'pointer'}}>
{chatGroupName.chat_name}</p><i id="profile-x"style={{cursor: 'pointer'}}>x</i>
</div>)
